...
if st.button('Predict'):
     arr= time_predictor(np.array([[20127.140625],
       [19969.771484],
       [19832.087891],
       [19986.712891],
       [19812.371094],
...
<div class="footer">
<p style="color: white;">Developed with ❤ by <a style='display: block; text-align: center;' >Graham Stanes,Fawziya,Sherwin</a></p>
</div>
"""
